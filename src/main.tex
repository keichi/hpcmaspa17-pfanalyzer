...
\begin{abstract}
    ...
    analysis on the  performance characteristics of dynamic interconnects, we
    develop a simulator specialized for dynamic interconnects. Our proposed
    ...
    of communication patterns collected by a dedicated tool. By using this
    toolset, we show how dynamically controlling the  interconnects can reduce
