...
\begin{abstract}
    ...
    for the simulation of packet flow in dynamically controlled interconnects,
    ...
    characteristics of dynamic interconnects, we have developed a simulator
    specialized to dynamic interconnects. Our simulator allows interconnect
    researchers and designers to investigate the congestion in the
    interconnect for an arbitrary cluster configuration and a set of
    communication patterns collected by a dedicated tool. The toolset is used
